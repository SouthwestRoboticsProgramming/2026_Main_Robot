...
public static final Pose2d kRCBlueTrenchPose  = new Pose2d(6.3, .6, new Rotation2d(0));
public static final Pose2d kRDSBlueTrenchPose = new Pose2d(3.5, .6, new Rotation2d(0));
...
public static final Pose2d kRCRedTrenchPose  = new Pose2d(9.5, .6, new Rotation2d(0));
public static final Pose2d kRDSRedTrenchPose = new Pose2d(13.3, .6, new Rotation2d(0));
