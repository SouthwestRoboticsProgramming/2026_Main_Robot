...
public class FieldPositions {
    ...
    // -------------------- Pass (Dual Corners) ----
    public static final Pose2d kBluePassRightPose = new Pose2d(1.6, 1.45, new Rotation2d(0));
    public static final Pose2d kBluePassLeftPose  = new Pose2d(1.6, 6.6, new Rotation2d(0));
    
    public static final Pose2d kRedPassLeftPose   = new Pose2d(15.0, 1.45, new Rotation2d(0));
    public static final Pose2d kRedPassRightPose  = new Pose2d(15.0, 6.6, new Rotation2d(0));
    ...
    public static Pose2d[] getAlliancePassPoses(Alliance alliance){
        return alliance == Alliance.Blue ? 
            new Pose2d[]{kBluePassLeftPose, kBluePassRightPose} : 
            new Pose2d[]{kRedPassLeftPose, kRedPassRightPose}; 
    }
}