...
public class FieldPositions {
    ...
    public static final Pose2d kBlueTrenchPose = new Pose2d(1.0, 4.105, new Rotation2d(0));
    public static final Pose2d kRedTrenchPose = new Pose2d(13.0, 4.105, new Rotation2d(0));
    ...
    public static Pose2d getAllianceTrenchPose(Alliance alliance){
        return alliance == Alliance.Blue ? kBlueTrenchPose : kRedTrenchPose;
